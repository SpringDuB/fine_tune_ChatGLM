...
def main():
    ...
    parser.add_argument("--jsonl_path", type=str, default="/mnt/workspace/llm/fine_tuneglm/datas/CoT")
    parser.add_argument("--save_path", type=str, default="data/COT_datasets")
    parser.add_argument("--max_seq_length", type=int, default=384)
    parser.add_argument("--skip_overlength", type=bool, default=False)
    parser.add_argument("--chatglm_path", type=str, default='/mnt/workspace/llm/Langchain-Chatchat/model_path/chatglm2-6b')
    parser.add_argument("--version", type=str, default='v2')
    args = parser.parse_args()
    data_path = args.jsonl_path + '/' + args.task + '.jsonl'
    dataset = datasets.Dataset.from_generator(
        lambda: read_jsonl(data_path, args.max_seq_length, args.chatglm_path, args.version, args.skip_overlength)
    )
    dataset.save_to_disk(args.save_path + '/' + args.task)
